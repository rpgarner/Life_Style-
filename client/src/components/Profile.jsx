    ...
    return (
     <div className='profilePage'>
        ...
        <div className='article'>
            <h3>Diets</h3>
            <img src="https://cdn.cancercenter.com/-/media/ctca/images/others/blogs/2019/06-june/02-blog-healthy-food-l.jpg" alt="food" />
        </div>
        <div className='article'>
            <h3>Goals</h3>
            <img src="https://shrm-res.cloudinary.com/image/upload/c_crop,h_705,w_1254,x_0,y_0/w_auto:100,w_1200,q_35,f_auto/v1/People%20Managers/Setting_goals_photo_vx3zxs.jpg" alt="goals" />
        </div>
        </div>
     </div>
    )
